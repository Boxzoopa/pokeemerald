...
const u16 gMetatiles_gGSC_General[] = INCBIN_U16("data/tilesets/primary/g_gsc_general/metatiles.bin");
const u16 gMetatileAttributes_gGSC_General[] = INCBIN_U16("data/tilesets/primary/g_gsc_general/metatile_attributes.bin");
